...
#         with open(f'conversations-{today}.csv', 'a', newline='', encoding='utf-8-sig') as file:
#             writer = csv.writer(file)
#             writer.writerow([user,'Human',inputString])
#             writer.writerow([user,'Assistant',conversation.messages[-1][-1]])
#         pass
#     except Exception as e:
#         print(f"Error occurred in CSV: {e}")